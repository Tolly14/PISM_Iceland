...
# 2007 and 2012 have different dims
    ...
    ncap2 -O -s "where(thk>4000) {thk=0; usurf=0;}; ftt_mask=topg*0; ftt_mask=ftt_mask+1;" pism_Langjokull_${year}.nc pism_Langjokull_${year}.nc
    ncatted -a standard_name,ftt_mask,d,, -a units,ftt_mask,d,,  pism_Langjokull_${year}.nc

...
for year in {1980..2016}; do
    ...
    cdo -O setmisstoc,273.15  -chname,tas,air_temp -selvar,tas, -setgrid,../../grids/harmonie.txt -mergetime ${hdir}/Daily2D_${year}*.nc harmonie/tas_HARMONIE_glac_corr_${year}.nc
...
# Merge the files seperately for climatic_mass_balance and air_temp
...
# Merge climatic_mass_balance and air_temp
...
ncatted -a _FillValue,climatic_mass_balance,d,, -a missing_value,climatic_mass_balance,d,, -a _FillValue,air_temp,d,, -a missing_value,air_temp,d,, HARMONIE_glac_corr_1980_2016_DM.nc
# Fix the time axis
adjust_timeline.py -d 1980-1-1 -a 1980-1-1 -p daily HARMONIE_glac_corr_1980_2016_DM.nc

# Monthly means (air_temp) and sums (climatic_mass_balance)
cdo -O -f nc4 -z zip_3 merge -monsum -selvar,climatic_mass_balance HARMONIE_glac_corr_1980_2016_DM.nc -monmean -selvar,air_temp HARMONIE_glac_corr_1980_2016_DM.nc HARMONIE_glac_corr_1980_2016_MM.nc
# Yearly means (air_temp) and sums (climatic_mass_balance)
cdo -O -f nc4 -z zip_3 merge -yearsum -selvar,climatic_mass_balance HARMONIE_glac_corr_1980_2016_DM.nc -yearmean -selvar,air_temp HARMONIE_glac_corr_1980_2016_DM.nc HARMONIE_glac_corr_1980_2016_YM.nc

...
for year in 97 98 99 00 01 02 03 04 05 06 07 08 09 10 11 12 13 14; do
    ...
    ncks -O -v lambert_conformal_conic -x summer_${cen}${year}.nc summer_${cen}${year}.nc  
    ...
    ncks -O -v lambert_conformal_conic -x winter_${cen}${year}.nc winter_${cen}${year}.nc  
    ncrename -v Band1,climatic_mass_balance winter_${cen}${year}.nc 
    ncap2 -O -s "climatic_mass_balance=climatic_mass_balance*910;" winter_${cen}${year}.nc winter_${cen}${year}.nc 

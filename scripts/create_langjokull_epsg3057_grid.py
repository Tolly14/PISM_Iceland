...
parser.add_argument("-g", "--grid_spacing", dest="grid_spacing", type=float,
                    help="use X m grid spacing", default=100)
...
if len(args) == 0:
    nc_outfile = 'langjokull' + str(int(grid_spacing)) + 'm.nc'
elif len(args) == 1:
    nc_outfile = args[0]
else:
...
if __name__ == "__main__":
    ...
    # define output grid(cell corners)
    e0 = 408150
    n0 = 430350
    e1 = 476450
    n1 = 500450
    ...
    # Set up EPSG 3057 (NSIDC north polar stereo) projection
    projection = "+init=epsg:3057"
